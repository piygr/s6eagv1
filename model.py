...
class PaintRectangleInput(BaseModel):
    shapeWidth: int
    shapeHeight: int

class PaintRectangleOutput(BaseModel):
    success: bool
    message: str

class PaintTextInsideRectangleInput(BaseModel):
    upperLeftX: int
    upperLeftY: int
    bottomRightX: int
    bottomRightY: int
...
class PaintTextInsideRectangleOutput(BaseModel):
    success: bool
    message: str